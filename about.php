...
?>
  <div class="section">
    ...
    <p>The Dirty Blondes Rock Band originated in 2006, when Christy and Al met playing in a Blues band decided to create a more commercially viable project. The band solidified with the rhythm section when Pete was recruited on bass and Jamie took over on drums.</p>
    ...
    <p>The Dirty Blondes are a synergistic force with a crowd pleasing repertoire and dynamic stage presence. Also, we have exceptional original songs and have been featured on local radio stations!</p>
  </div>
<?php
